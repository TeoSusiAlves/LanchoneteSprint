...
namespace LanchoneteSprint2.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public FornecedoresController(ClientContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Fornecedores != null ? 
                          ...
                          Problem("Entity set 'ClientContext.Fornecedores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'ClientContext.Fornecedores'  is null.");
            }
            var fornecedor = await _context.Fornecedores.FindAsync(id);
            if (fornecedor != null)
            {
